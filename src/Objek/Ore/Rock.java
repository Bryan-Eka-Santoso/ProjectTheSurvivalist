...
public class Rock extends Ore{
    ...
    public Rock(int x, int y, GamePanel gp) {
        super(50, x, y, gp.TILE_SIZE , gp.TILE_SIZE, gp, new Rectangle((int)(1*scaleFactor), (int)(1*scaleFactor), (int)(29*scaleFactor), (int)(28*scaleFactor)));
        this.collision = true;
        try {
            this.image = ImageIO.read(getClass().getResource("/res/Ore/rock.png"));
