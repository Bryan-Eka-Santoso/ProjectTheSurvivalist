...
1 - 9 → Memilih item yang ingin digunakan sesuai dengan slot item yang dibawa pemain
S (dalam mode chest/inventory) → Menukar dan memindahkan item yang dipilih antara chest dan inventory
E → Digunakan untuk menyerang musuh, menebang pohon, dan menghancurkan bangunan
Spasi (Spacebar) → Digunakan untuk masuk dan keluar dari toko (Shop) serta menjelajahi dan meninggalkan gua (Cave)